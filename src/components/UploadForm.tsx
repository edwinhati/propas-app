...
export default function UploadForm({ ktpFile, setKtpFile, loading }: any) {
  return (
    <Fragment>
        ...
        >
          {ktpFile ? (
            <>
              ...
              />
              {/* <div className="flex flex-col items-center justify-center absolute bottom-0 w-full h-16 bg-gray-900 bg-opacity-50 rounded-b-lg">
                <p className="text-xs text-white">
                  {ktpFile.name} ({ktpFile.size / 1000} KB)
                </p>
              </div> */}
            </>
          ) : (
